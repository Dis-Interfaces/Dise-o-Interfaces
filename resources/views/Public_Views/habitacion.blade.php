                    ...
                    <form action="{{ route('reservaciones.store2') }}" method="POST" onsubmit="handleFormSubmit(event)">
                        ...
                        <div class="form-group-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control" required aria-label="Campo para ingresar el nombre del cliente">
                            </div>
                            <div class="form-group">
                                <label for="telefono">Teléfono</label>
                                <input type="text" name="telefono" id="telefono" class="form-control" required aria-label="Campo para ingresar el número de teléfono">
                            </div>
                        </div>
                        <div class="form-group-row">
                            <div class="form-group">
                                <label for="direccion">Dirección</label>
                                <input type="text" name="direccion" id="direccion" class="form-control" required aria-label="Campo para ingresar la dirección">
                            </div>
                            <div class="form-group">
                                <label for="email">Correo Electrónico</label>
                                <input type="email" name="email" id="email" class="form-control" required aria-label="Campo para ingresar el correo electrónico">
                            </div>
                        </div>
                        <div class="form-group-row">
                            <div class="form-group">
                        ...
                        <div class="form-group-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="codigo_promocional" id="codigo_promocional" class="form-control" aria-label="Ingresar cupón promocional">
                            </div>
                            <div class="form-group">
